...
export const scenes: SceneModule[] = [
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        facts: [
          "Peak pressure ≈ 25 mmHg",
          "Wall thickness ≈ 3–5 mm",
          "Shares the interventricular septum",
        ],
      },
      {
        id: "left-atrium",
        ...
        facts: [
          ...
          "Atrial kick adds ~20% of filling",
          "Site of most atrial fibrillation",
        ],
      },
      {
        id: "right-atrium",
      ...
      },
      {
        ...
        facts: [
          "Diameter ≈ 25 mm at the root",
          "Gives off three arch branches",
          "Elastic lamellae store systolic energy",
        ],
      },
      {
        id: "pulmonary-artery",
      ...
      },
      {
        ...
        facts: [
          "LAD supplies ~50% of the LV",
          "Occlusion → myocardial infarction",
          "Flow peaks in diastole",
        ],
      },
      {
        id: "mitral-valve",
        ...
        facts: [
          ...
          "Closure produces the S1 heart sound",
          "Area ≈ 4–6 cm²",
        ],
      },
    ],
    ...
    hotspots: [
      {
        ...
        facts: [
          "Bicyclic xanthine scaffold",
          "Fully conjugated π system",
          "Planarity drives receptor binding",
        ],
      },
      {
        id: "n-methyls",
        ...
        facts: [
          ...
          "log P ≈ -0.07",
          "Removing methyls gives theobromine/theophylline",
        ],
      },
      {
        id: "carbonyls",
        ...
        facts: [
          "Both are amide-like carbonyls",
          "Key acceptors at the A2A receptor",
          "Dipole ≈ 3.6 D",
        ],
      },
      {
        ...
        facts: [
          "pKa of conjugate acid ≈ 0.6",
          "sp² lone pair, in-plane",
          "Coordination site for metal complexes",
        ],
      },
      {
        id: "planarity",
        ...
        facts: [
          "Bond angles ≈ 120°",
          "Stacks at ~3.4 Å spacing",
          "Explains crystal packing behaviour",
        ],
      },
    ],
  },
    ...
    hotspots: [
      {
        ...
        facts: [
          "Replaces heavy groin vaults",
          "Ribs built first as permanent centering",
          "Webbing can be thin infill",
        ],
      },
      {
        id: "pointed-arch",
        ...
        facts: [
          "Reduces lateral thrust",
          "Decouples span from height",
          "Arrived via Islamic building traditions",
        ],
      },
      {
        id: "compound-pier",
        ...
        facts: [
          "Shafts mirror vault ribs",
          "Carries concentrated point loads",
          "Expresses verticality",
        ],
      },
      {
        id: "flying-buttress",
        ...
        facts: [
          "Pinnacles add stabilising weight",
          "Beauvais failed by overreaching",
          "Enables 40 m+ vault heights",
        ],
      },
      {
        id: "clerestory",
        ...
        facts: [
          "Bar tracery after Reims",
          "Coloured light as divine metaphor",
          "Wall becomes a membrane",
        ],
      },
      {
        id: "triforium",
        ...
        facts: [
          ...
          "Often a narrow walkway",
          "Later glazed at Saint-Denis",
        ],
      },
    ],
  },
    ...
    hotspots: [
      {
        ...
        category: "Star",
        summary:
          "The dominant mass in the system; its gravity supplies the centripetal acceleration that bends planetary motion into orbits.",
        facts: [
          "Contains over 99% of system mass",
          "Gravity falls with distance squared",
          "Fusion powers its luminosity",
        ],
      },
      {
        id: "earth-orbit",
        name: "Terrestrial Orbit",
        position: [3.25, 0.28, 0.55],
        category: "Orbit",
        summary:
          "A near-circular path where tangential velocity continually carries the planet forward as gravity pulls it inward.",
        facts: [
          "One revolution defines a year",
          "Orbital speed is about 29.8 km/s",
          "Eccentricity is low",
        ],
      },
      {
        ...
        position: [3.78, 0.34, 0.55],
        category: "Satellite",
        summary:
          "A secondary body bound to a planet while both orbit their common barycentre and the central star.",
        facts: ["Tidally locked", "Drives most ocean tides", "Orbit slowly expands"],
      },
      {
        id: "mars",
        name: "Outer Terrestrial Planet",
        position: [-4.45, 0.45, 1.2],
        category: "Planet",
        summary:
          "A smaller rocky world on a wider, slower orbit, illustrating the relationship described by Kepler's third law.",
        facts: [
          "Orbital period about 687 days",
          "Two small moons",
          "More eccentric orbit than Earth",
        ],
      },
      {
        id: "jupiter",
        name: "Gas Giant",
        position: [5.55, -0.35, -2.3],
        category: "Planet",
        summary:
          "The system's largest planet strongly perturbs smaller bodies and helps shape resonances in the asteroid belt.",
        facts: ["Largest planetary mass", "Rapid ten-hour rotation", "Powerful magnetosphere"],
      },
    ],
  },
  {
    ...
    hotspots: [
      {
        ...
        category: "Landform",
        summary:
          "An underwater mountain chain built where plates separate and hot material rises to create new oceanic crust.",
        facts: ["Longest mountain system on Earth", "High heat flow", "Hosts hydrothermal vents"],
      },
      {
        id: "left-plate",
        name: "Diverging Plate",
        position: [-2.1, 0.25, 0],
        category: "Lithosphere",
        summary:
          "A rigid slab moving away from the spreading centre as new crust is added along its inner edge.",
        facts: [
          "Moves centimetres per year",
          "Carries symmetric magnetic stripes",
          "Cools and thickens with age",
        ],
      },
      {
        id: "magma",
        name: "Mantle Upwelling",
        position: [0, -1.15, 0],
        category: "Mantle",
        summary:
          "Hot mantle rises and partially melts as pressure falls, feeding basaltic magma into the spreading axis.",
        facts: ["Decompression melting", "Produces basalt", "Transfers interior heat"],
      },
      {
        id: "rift",
        name: "Axial Rift",
        ...
        category: "Fault Zone",
        summary:
          "The central valley where extension fractures young crust and focuses volcanic activity.",
        facts: [
          "Dominated by normal faults",
          "Frequent shallow earthquakes",
          "Crust is youngest here",
        ],
      },
    ],
  },
    ...
    hotspots: [
      {
        ...
        category: "Input",
        summary:
          "The input gear receives shaft power and establishes the starting angular velocity and torque for the train.",
        facts: [
          "Input member",
          "Rotation drives adjacent gear oppositely",
          "Power equals torque × angular velocity",
        ],
      },
      {
        id: "driven-gear",
        ...
        category: "Output",
        summary:
          "A smaller meshing gear rotates faster than the larger driver while transmitting proportionally less torque, before losses.",
        facts: [
          "Speed ratio follows tooth count",
          "Direction reverses at each mesh",
          "Contact occurs along tooth profiles",
        ],
      },
      {
        id: "idler",
        name: "Idler Gear",
        position: [0.65, -1.45, 0.4],
        category: "Transfer",
        summary:
          "An intermediate gear changes rotation direction and spacing without changing the overall ratio set by input and output gears.",
        facts: ["Does not alter overall ratio", "Redirects motion", "Adds bearing and mesh losses"],
      },
      {
        id: "gear-mesh",
        name: "Meshing Teeth",
        ...
        category: "Contact",
        summary:
          "Involute tooth profiles maintain a nearly constant velocity ratio as contact travels across each pair of teeth.",
        facts: ["Involute profile", "Requires backlash", "Lubrication limits wear"],
      },
    ],
  },
  {
    ...
    hotspots: [
      {
        ...
        category: "Node",
        summary:
          "The entry point of every search. Each comparison at the root discards roughly half the remaining keys when the tree is balanced.",
        facts: ["Holds key 50 here", "Every search starts here", "No parent pointer"],
      },
      {
        id: "left-subtree",
        name: "Left Subtree",
        ...
        category: "Invariant",
        summary:
          "Every key in this subtree is smaller than its parent — the ordering invariant that makes search logarithmic instead of linear.",
        facts: ["All keys < parent", "Checked on every insert", "In-order walk yields sorted keys"],
      },
      {
        id: "leaf",
        name: "Leaf Node",
        ...
        category: "Node",
        summary:
          "A node with no children. Searches that reach a leaf without a match have failed, costing one comparison per level travelled.",
        facts: ["Zero children", "Where inserts attach", "Deepest comparison point"],
      },
      {
        id: "height",
        name: "Tree Height",
        ...
        category: "Complexity",
        summary:
          "The longest root-to-leaf path. Balanced trees keep it near log₂(n), giving O(log n) search; sorted inserts push it to n and O(n).",
        facts: ["Balanced: O(log n)", "Degenerate: O(n)", "AVL and red-black trees rebalance"],
      },
      {
        id: "traversal",
        ...
        category: "Algorithm",
        summary:
          "In-order, pre-order and post-order visits differ only in when the node is read relative to its children — same walk, different output.",
        facts: [
          "In-order returns sorted data",
          "Pre-order copies structure",
          "Post-order frees safely",
        ],
      },
    ],
  },
    ...
    hotspots: [
      {
        ...
        category: "Structure",
        summary:
          "Alternating deoxyribose and phosphate groups form a covalent, negatively charged rail that gives the molecule its directionality.",
        facts: [
          "Linked by phosphodiester bonds",
          "Runs 5′ → 3′",
          "Negative charge aids protein binding",
        ],
      },
      {
        id: "base-pair",
        name: "Complementary Base Pair",
        position: [0, 0.4, 0],
        category: "Chemistry",
        summary:
          "Adenine pairs with thymine via two hydrogen bonds; guanine pairs with cytosine via three — which is why GC-rich DNA melts at a higher temperature.",
        facts: [
          "A–T: 2 hydrogen bonds",
          "G–C: 3 hydrogen bonds",
          "Pairing enables faithful copying",
        ],
      },
      {
        id: "antiparallel",
        name: "Antiparallel Strands",
        position: [-1.5, -2.4, 0],
        category: "Geometry",
        summary:
          "The two strands run in opposite chemical directions, which forces replication to be continuous on one strand and fragmented on the other.",
        facts: [
          "One 5′→3′, one 3′→5′",
      ...
      {
        id: "grooves",
        name: "Major and Minor Grooves",
        position: [1.6, -4.4, 0],
        category: "Recognition",
        summary:
          "Unequal backbone spacing creates a wide and a narrow groove; transcription factors read base identity mostly through the major groove.",
        facts: [
          "Major groove ≈ 2.2 nm wide",
          "Protein recognition site",
          "Minor groove binds small drugs",
        ],
      },
      {
        id: "pitch",
        ...
        category: "Geometry",
        summary:
          "One full turn spans about 10.5 base pairs and 3.4 nm, so each base pair sits 0.34 nm above and roughly 34° around from the last.",
        facts: ["Right-handed B-form", "3.4 nm per turn", "0.34 nm base-pair rise"],
      },
    ],
  },
  {
    ...
    hotspots: [
      {
        id: "source-a",
        name: "Coherent Source A",
        position: [-2.4, 0.6, 2.2],
        category: "Source",
        summary:
          "A point source radiating circular wavefronts at a fixed frequency and phase — coherence is what makes a stable pattern possible.",
        facts: ["Fixed frequency", "Constant phase relationship", "Amplitude falls with distance"],
      },
      {
        id: "source-b",
        name: "Coherent Source B",
        position: [2.4, 0.6, 2.2],
        category: "Source",
        summary:
          "A second identical source. Its separation from source A sets the angular spacing of the resulting fringes.",
        facts: [
          "Same wavelength as A",
          "Separation sets fringe spacing",
          "Analogous to a double slit",
        ],
      },
      {
        id: "constructive",
        name: "Constructive Ridge",
        position: [0, 1.6, 0],
        category: "Superposition",
        summary:
          "Along the perpendicular bisector both waves arrive in phase, so displacements add and amplitude doubles.",
        facts: ["Path difference = nλ", "Amplitude adds", "Intensity ∝ amplitude²"],
      },
      {
        id: "destructive",
        name: "Nodal Line",
        ...
        category: "Superposition",
        summary:
          "Where the path difference is an odd number of half wavelengths, one crest meets a trough and the surface stays flat.",
        facts: [
          "Path difference = (n+½)λ",
          "Total cancellation",
      ...
      },
      {
        ...
        category: "Quantity",
        summary:
          "The crest-to-crest spacing. Shorter wavelengths pack fringes closer together for the same source separation.",
        facts: ["λ = v / f", "Sets fringe spacing", "Same maths for light, sound and water"],
      },
    ],
  },
  {
    ...
    hotspots: [
      {
        ...
        category: "Ion",
        summary:
          "Losing one electron shrinks sodium dramatically, so the cation slots into the gaps between much larger chloride ions.",
        facts: ["Ionic radius ≈ 102 pm", "Charge +1", "Six chloride neighbours"],
      },
      {
        id: "anion",
        name: "Chloride Anion",
        ...
        category: "Ion",
        summary:
          "Gaining an electron expands the ion; chloride dominates the lattice volume and defines the packing arrangement.",
        facts: ["Ionic radius ≈ 181 pm", "Charge −1", "Six sodium neighbours"],
      },
      {
        id: "coordination",
        ...
        category: "Geometry",
        summary:
          "Each ion is octahedrally surrounded by six of the opposite charge — the 6:6 arrangement typical of the rock-salt structure.",
        facts: ["6:6 coordination", "Octahedral geometry", "Set by the radius ratio"],
      },
      {
        id: "lattice-energy",
        name: "Lattice Energy",
        ...
        category: "Energetics",
        summary:
          "The energy released as gaseous ions assemble into the lattice; its size explains the 801 °C melting point and low solubility of harder salts.",
        facts: [
          "≈ −787 kJ/mol for NaCl",
          "Rises with charge, falls with radius",
          "Drives high melting points",
        ],
      },
      {
        id: "cleavage",
        ...
        category: "Property",
        summary:
          "Sliding one layer by a single ion aligns like charges, so the crystal shatters along flat planes instead of deforming.",
        facts: ["Brittle failure", "Cleaves at 90° angles", "No delocalised electrons to flow"],
      },
    ],
  },
];
